...
class Diesel(AbstractSite):
    ...
    def _parse_ulr_and_external_id(self, href: str) -> tuple[str, int]:
        url = urlparse(href)
        external_id = int(url.query.split("showtopic=")[-1])
    ...
    def _get_span_contains_str(self, page: BeautifulSoup, text: str) -> str:
    ...
    def _parse_body(self, page: BeautifulSoup) -> str:
