...
// WriteApartment - records Apartment in the database with the pictures and returns Id to the structure.
...
// CleanFromExistApartments - clears the map of offers that are already in the database
...
// Dislike - mark apartment as bad for user or group and return all message ids (description and photos) for delete from chat.
